<template>
  <div class="app-container">
    ...
    <!-- 添加或修改定时任务对话框 -->
    <jq-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
              ...
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    ...
                    <br />Class类调用示例：com.jq.quartz.task.RyTask.ryParams('ry')
    ...
    <!-- 任务日志详细 -->
    <jq-dialog title="任务详细" :visible.sync="openView" width="700px" append-to-body>
