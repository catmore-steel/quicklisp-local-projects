        ...
        <div style="display: flex; padding: 10px 0px; justify-content: space-between;">
          <div>
            ...
            <el-tooltip effect="dark" content="新建" placement="bottom">
              <el-button  icon="el-icon-circle-plus" @click="newDiagram" />
            </el-tooltip>
          ...
          <div>
            <el-button  icon="el-icon-view" @click="showXML">查看xml</el-button>
            <el-button  icon="el-icon-download" @click="saveXML(true)">下载xml</el-button>
            <el-button  icon="el-icon-picture" @click="saveImg('svg', true)">下载svg</el-button>
        ...
        for (var gKey in allGroups) {
          ...
          for (var cKey in group.children) {
            ...
            if (
              ...
              if (control.dataset.action.indexOf("-tool") > 0 ){ //tool
                var text = control.title;
                control.innerHTML = `<div style='font-size: 14px;font-weight:500;margin-left:15px;'>` + text.substr(0,4) +`</div>`
              }else{
